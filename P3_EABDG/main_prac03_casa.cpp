...
Para poder observar la imagen se debe desplazar en la coordenada de Z alejandose, esto de hace con la letra S.
...
void display(void)
{
	...
	//Se modifica el color de todos los cubos
	colorShader.setVec3("modColor", 0.039f, 0.243f, 0.803f);  //Azul
